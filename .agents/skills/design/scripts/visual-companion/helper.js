(function() {
  ...
  function sessionKey() {
    try {
      return window.sessionStorage && window.sessionStorage.getItem('agent-workflow-session-key');
    } catch (e) {}
    return null;
  }
  ...
  function showTombstone() {
    ...
    el.innerHTML = '<div style="max-width:480px">' +
      ...
      '<p style="margin:0;opacity:.85">The agent workflow companion has stopped. ' +
