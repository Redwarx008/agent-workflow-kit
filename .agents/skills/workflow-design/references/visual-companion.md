...
- PowerShell: `.agents/skills/workflow-design/scripts/visual-companion/start.ps1 -ProjectRoot <root> -Open`
- Bash: `bash .agents/skills/workflow-design/scripts/visual-companion/start.sh --project-dir <root> --open`
...
- PowerShell: `.agents/skills/workflow-design/scripts/visual-companion/stop.ps1 -SessionDir <session_dir>`
- Bash: `bash .agents/skills/workflow-design/scripts/visual-companion/stop.sh <session_dir>`
